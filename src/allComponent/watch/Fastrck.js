...
import { addtoCart } from "../../fiture/Store.js/Slice";
           ...
           export default function Fastrck (){
            ...
            useEffect(()=>{
                ...
                .then((res)=>setData(res.data.filter(item => item.type === "fastrack")))
                ...
                return (
                    ...
                    <Header/>
                         ...
                         <div className="watch_SubParent">
                           ...
                           {
                             data.filter((item)=>item.type==="fastrack").slice(0,loadData).map((item,index)=>{
